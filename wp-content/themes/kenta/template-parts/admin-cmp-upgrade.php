...
<div data-dismiss-url="<?php echo esc_url( $dismiss_url ) ?>"
    ...
    <div class="kcmp-upgrade-message">
        ...
        <p>
			<?php
			esc_html_e( 'The Kenta Companion Plugin you are using is not compatible with the current theme, please update to the latest version or some features will be broken.', 'kenta' );
			?>
        </p>
