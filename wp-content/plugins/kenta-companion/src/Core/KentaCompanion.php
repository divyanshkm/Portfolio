...
class KentaCompanion extends Container {
	...
	public function __construct() {
		...
		if ( is_admin() ) {
			...
			if ( $kenta_version !== false && version_compare( $kenta_version, MIN_KENTA_VERSION, '<' ) ) {
				add_action( 'admin_notices', [ $this, 'kenta_need_upgrade_notice' ] );
			}
		}
	}
	...
	/**
	 * Need upgrade kenta theme
	 */
	public function kenta_need_upgrade_notice() {
		kcmp_get_template_part( 'kenta-upgrade-notice' );
	}
}